...
(like a space - " "), you can use the `str_split_fixed()` function to split the 
string up. The `pattern` is the separating character and the `n` is the maximum 
number of parts you want a string split into.
